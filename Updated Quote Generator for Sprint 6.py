    ...
    if username.get() not in employee_cred:
        ...
        class QuoteGenerator:
            ...
            def __init__(self):
                ...
                Label(form, text = "Product Price per sq. foot").grid(row = 10, column = 1, sticky = W)
                #Both the Product Price and Tax labels have been modified to be more clear to the user what input is being requested
                Label(form, text = "Tax Rate (as whole number)").grid(row = 11, column = 1, sticky = W)
